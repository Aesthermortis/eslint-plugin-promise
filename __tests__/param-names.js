...
const messageForResolve = 'Promise constructor parameters must be named to match "^_?resolve$"';
const messageForReject = 'Promise constructor parameters must be named to match "^_?reject$"';
